...
const AboutPage = () => {
  ...
  const architectImageUrl = "YOUR_CUSTOM_IMAGE_URL_HERE"; 
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <motion.div
            ...
            whileHover={{ scale: 1.15, rotate: -7, transition: { type: "spring", stiffness: 280 } }}
        ...
        >
          {stats.map((stat) => (
            <motion.div
              ...
              whileHover={{ y: -10, transition: { type: 'spring', stiffness: 280, damping: 15 } }}
            >
              <Card className="glass-effect neon-border text-center hover:cyber-glow transition-all duration-300 h-full">
                <CardContent className="p-6 md:p-8 flex flex-col items-center justify-center h-full">
                  <motion.div
                    whileHover={{ rotate: [0, 20, -15, 15, 0], scale: 1.15 }}
            ...
            <CardContent className="p-8 md:p-10">
              <div className="space-y-6 text-gray-300 leading-relaxed text-lg">
                <p>
                  ...
                  Our architect, <span className="text-purple-300 font-semibold hover:text-pink-400 transition-colors duration-200">HACKERPRO</span>, 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {values.map((value) => (
              <motion.div
                key={value.title}
                variants={itemVariants}
                whileHover={{ y: -12, transition: { type: 'spring', stiffness: 260 } }}
              >
        ...
        >
          <Card className="glass-effect neon-border cyber-glow max-w-2xl mx-auto overflow-hidden">
            ...
            <CardContent className="p-8 md:p-10">
              <motion.div
                whileHover={{ scale: 1.08, y: -8, transition: { type: 'spring', stiffness: 250 } }}
                className="mb-6"
              >
                <img  
                  ...
                  src={architectImageUrl === "YOUR_CUSTOM_IMAGE_URL_HERE" ? "https://images.unsplash.com/photo-1677442135131-4d7c123aef1c" : architectImageUrl}
                 />
              </motion.div>
              ...
              <div className="flex justify-center space-x-4">
                <Button asChild variant="outline" className="border-green-500/50 text-green-300 hover:bg-green-500/20 hover:text-green-200 cyber-glow transition-all duration-200 hover:scale-105">
                  <a href="https://wa.me/+233557488116" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
                    <MessageCircle className="h-5 w-5" /> WhatsApp
                  </a>
                </Button>
                <Button asChild variant="outline" className="border-blue-500/50 text-blue-300 hover:bg-blue-500/20 hover:text-blue-200 cyber-glow transition-all duration-200 hover:scale-105">
