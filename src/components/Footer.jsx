...
const Footer = () => {
  ...
  return (
    <footer className="glass-effect border-t border-purple-500/30 mt-auto py-12 z-10">
            ...
            <ul className="space-y-2">
              {footerLinks.map(link => (
                <li key={link.label}>
                  ...
                  >
                    <ArrowRight className="h-3 w-3 mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-purple-400" />
                    {link.label}
                  </Link>
                </li>
              ))}
