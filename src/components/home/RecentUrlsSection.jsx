  ...
  useEffect(() => {
    ...
    const channel = supabase.channel('realtime short_urls')
      .on('postgres_changes', { event: '*', schema: 'public', table: 'short_urls' }, payload => {
        ...
        fetchUrls(); // Refetch on any change
      })
      .subscribe()
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center space-x-2 mt-3 sm:mt-0 flex-shrink-0">
                       <Button
                        ...
                        className="border-purple-500/40 text-purple-400 hover:bg-purple-500/20 h-10 w-10"
                      ...
                      >
                       ...
                       <Button
                        ...
                        className="border-red-500/40 text-red-400 hover:bg-red-500/20 h-10 w-10"
