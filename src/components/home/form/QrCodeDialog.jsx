...
const QrCodeDialog = ({ open, onOpenChange, shortUrl, qrCodeValue }) => {
  ...
  useEffect(() => {
    if (open) {
      ...
      const cardBgDark = '#141420';
      const primaryColorLight = '#6D28D9'; // Example: Tailwind purple-700
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px] glass-effect neon-border">
        ...
        <motion.div 
          className="py-4 flex justify-center items-center bg-card rounded-md"
        ...
        <DialogFooter>
          <Button onClick={downloadQrCode} className="bg-gradient-to-r from-purple-600 to-cyan-500 text-white pulse-glow w-full sm:w-auto">Download QR</Button>
